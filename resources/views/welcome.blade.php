...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <div class="relative min-h-screen flex flex-col items-center selection:bg-[#34b58e] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-12 lg:grid-cols-2">
                    <a class="flex lg:col-start-1" href="{{ url('/') }}">
                        <img class="h-12 w-auto lg:h-16" src="../../logo.png">
                    </a>
                    @if (Route::has('login'))
                ...
                <main class="mt-6">
                    <div class="text-center text-lg py-14">
                        <h2> {{ __('auth.welcome') }} </h2>
                    </div>
                </main>

                <footer class="py-80 text-center text-sm text-black dark:text-white/70">
